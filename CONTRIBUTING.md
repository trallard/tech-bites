...
2. [Fork][link_fork] the [tech-bites repo][link_repo] to your profile.
...
You can follow the same process as for any other contributions as described above. In short:

1. Create an [issue][issues] to let us know you are contributing a translation. Make sure to use the correct template. 
2. Translate the graphic ans submit this a markdown file. We follow this convention for files: `<two letters language identifier>/topic/title.md`. So if you wanted to translate for example the serverless graphic to Portuguese you'd need to add ad `PT/serverless/serverless_101.md` file.
3. Submit your PR and wait for approval 🎉.
...
[labels]: https://github.com/trallard/tech-bites/labels
[repository]: https://github.com/trallard/tech-bites
